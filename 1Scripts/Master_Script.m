...
time_variant_variables ...
          = {'MURDER_PER_100kPOPULATION'};
         
time_invariant_variables ...
          = {'log AVERAGE_POPULATION (in millions)',...             
             'OFFICERS_PER_1000POP',...
             'GUN_DEATH_RATE(%)',...
             'SHARE_POVERTY',...
             'SHARE_BLACK',...
             'GARNER',...
...
input.data = T_results_variant_raw
input.tableColLabels = {'Time_Varying_Covariates','Beta','Standard_errors'}
