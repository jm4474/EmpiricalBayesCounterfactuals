function [table] = bootstrap_create_table_unobs_obs(NAMES_aux_sorted,CIs,CIs_sum)
%% BOOTSTRAP_CREATE_TABLE_UNOBS_OBS: This function creates Latex that can be used to generate a table of counterfactual values of lethal encounters
%
...
%%
dfile= '../4Output/tex/Table_Bootstrap_Counterfactual_Unobs_Obs.tex'
