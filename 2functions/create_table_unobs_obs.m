function [table] = create_table_unobs_obs(NAMES_aux_sorted,CIs,CIs_sum)
%% CREATE_TABLE_UNOBS_OBS: This function creates Latex that can be used to generate a table of counterfactual values of lethal encounters
%
