function [table] = bootstrap_create_table_obs(NAMES_aux_sorted,CIs,CIs_sum)
%% BOOTSTRAP_CREATE_TABLE_OBS: This function creates Latex that can be used to generate a table of counterfactual values of lethal encounters
%
...
%%
diary '../4Output/tex/Table_Bootstrap_Counterfactual_Obs.txt'
fprintf('\\begin{table}[h!]\\centering\\scriptsize\\tabcolsep=0.1cm\\caption{Counterfactual police homicides for 2013-2018: Observed Covariates} \\label{table:bootstrap_counterfactual_obs}\\begin{tabular}{lrrrrrrrrrr}\\hline \\hline')
T = '';
