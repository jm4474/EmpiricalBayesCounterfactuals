...
tt = ph4 + lv4 + dl4 + la4 + sa4 + hu4 + sd4 + ch4 + pl4 + ny4;
...
totalhomicides = '3820';
percentagehomicides = string(round(((tt/str2num(totalhomicides))*100)));
...
avgyearlyencounters = string(round(str2num(finalhomicides)/6));
reductionpoverty = string(round(avgyearlyencounters*(str2num(povertypercentage)/100)));
newyorkreduction = string(totalincidentsten - nyt); 
