function [table] = bootstrap_create_table_unobs(NAMES_aux_sorted,CIs,CIs_sum)
%% BOOTSTRAP_CREATE_TABLE_UNOBS: This function creates Latex that can be used to generate a table of counterfactual values of lethal encounters
%
% Author: José Luis Montiel Olea. Last Revised: May 29th, 2021
%
% Built using MATLAB Version: 9.10.0.1538726 (R2021a) Prerelease
%
% Syntax: [table] = bootstrap_create_table_unobs(NAMES_aux_sorted,CIs,CIs_sum)
%
% INPUT:
...
%%
dfile = '../4Output/tex/Table_Bootstrap_Counterfactual_Unobs.txt'
if exist(dfile, 'file') ; delete(dfile); end
diary(dfile)
diary on

fprintf('\\begin{table}[h!]\\centering\\scriptsize\\tabcolsep=0.1cm\\caption{Counterfactual police homicides for 2013-2018: Unobserved Covariates} \\label{table:bootstrap_counterfactual_unobs}\\begin{tabular}{lrrrrrrrrrr}\\hline \\hline')
T = '';
